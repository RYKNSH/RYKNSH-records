...
│テスト   │コンテンツ│営業    │危機管理 │tune    │Studio  │ファン参加   │
│CI/CD   │教育     │イベント │ブランド │RAG     │Stream  │IP育成      │
├────────┼────────┼────────┼────────┼────────┼────────┼────────────┤
...
| 1.5 | M2-4 | **⑤ Ada** (AI R&D) | AI基盤SaaS |
| 2 | M3-6 | **② Lumina** | デザイン・映像受託 |
| 3 | M6-9 | **③ Cyrus** (Mktg+Sales) | グロースSaaS |
| 4 | M9-12 | **④ Iris** (PR/防衛) | PR・危機管理SaaS |
| 3.5 | M7-10 | **⑥ Noah** (コミュニティ) | BtoB PF 手数料 |
