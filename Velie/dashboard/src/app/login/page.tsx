            ...
            <div className="relative z-10 w-full max-w-md px-6">
                ...
                <div className="glass p-8">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-3 w-full py-3 rounded-xl bg-white text-gray-900 font-medium text-sm hover:bg-gray-100 transition-all hover:shadow-lg cursor-pointer"
                    >
